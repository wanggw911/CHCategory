...
- (void)createOnePXHeightSeparationLineWithFrame:(CGRect)frame bgColor:(UIColor *)color
{
    //为了在retina屏中创建0.5个点的边框，非retina屏要 * 2 ,因为0.5在此屏中创建不出来
    CGFloat calculateHeight = 0.5;
    ...
    frame.size.height = calculateHeight;
    frame.origin.y = CGRectGetHeight(self.frame) - calculateHeight;
